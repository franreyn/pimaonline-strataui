  ...
  return (
    <AssignmentsWidgetWrapper>
      <AssignmentItem>
        ...
        <a href="javascript:void(0);" target="_blank" className="button">Module 1 Readings</a>
      </AssignmentItem>
      <AssignmentItem>
        <h3>Reading Review Activity</h3>
        <p>Rhetorical Analysis Review Activity</p>
        <a href="javascript:void(0);" target="_blank" className="button">Reading Review Activity</a>
      </AssignmentItem>
      <AssignmentItem>
        <h3>Writing Assignment 1</h3>
        <p>Rhetorical Analysis Draft</p>
        <a href="javascript:void(0);" target="_blank" className="button">Writing Assignment 1</a>
      </AssignmentItem>
    </AssignmentsWidgetWrapper>
  )
}